...
All in all, the relationship weather has on likelihood of bike rentals occurring performed well within my expectations. The model ran as I thought it would, and even the challenges of utilizing foreign formats was easily overcome by finding the most apropos coding to adjust the inputs. I found this exercise refreshing as a lesson in that sometimes the data does actually fall within how we expect it to.
